...
def predict():
    if request.method == "POST":
        ...
        airline = [
            "Jet Airways", "IndiGo", "Air India", "Multiple carriers", "SpiceJet", "Vistara", "GoAir", "Multiple carriers Premium economy", "Jet Airways Business", "Vistara Premium economy", "Trujet"
        ]

        logo = ["jetairways.png",
                "indigo.jpg",
                "airindia.jpg",
                "Multiple carriers Premium economy.jpg",
                "SpiceJet.png",
                "vistara.png",
                "goair.png",
                "Multiple carriers Premium economy.jpg",
                "Jet Airways Business.png",
                "Vistara Premium economy.png",
                "Trujet.jpg"]
    ...
    #    'Destination_Kolkata', 'Destination_New Delhi']
        ...
        for i in airline:
            ...
            result.append(round(prediction[0], 2))

        # return render_template('index.html',prediction_text="Your Flight price is Rs. {}".format(output))
        print(result)

        return render_template('show.html', value=dict(zip(airline, result)), enumerate=enumerate, logo=logo)
